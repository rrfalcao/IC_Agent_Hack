...
This is a minimal Bun HTTP agent built with `@aweto-agent/core`. It provides a simple starting point with basic entrypoint configuration and optional payment support.
...
- Import types from `@aweto-agent/core/types`
...
- [@aweto-agent/core documentation](../../../core/README.md)
